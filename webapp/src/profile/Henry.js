...
export const Henry = () => {
  const style2 = {
    backgroundImage:
      "url('https://images.pexels.com/photos/5490276/pexels-photo-5490276.jpeg?auto=compress&cs=tinysrgb&w=600')",
  };
  return (
    <div>
      <div className="nav">
          ...
          >
            <div class="p-4 md:p-12 text-center lg:text-left">
              ...
              <p class="pt-8 text-sm">
                Dr. Henry is a compassionate and experienced Mental Health
                Counselor with expertise in anxiety, depression, trauma, and
                relationship issues. He provides personalized support and
                evidence-based therapies to help clients achieve emotional
