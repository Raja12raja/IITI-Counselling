...
export const Usercontact = () => {
  ...
  return (
    ...
    <div>
      ...
      <div className=" contactpage relative mx-auto w-full max-w-7xl bg-white text-gray-700">
      <div className="grid grid-cols-2">
        
        {/* :MAP CONTAINER */}
        <div className="order-1 col-span-full">
          <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d4151.525549143382!2d75.92126574139262!3d22.529426986673474!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sin!4v1690282831958!5m2!1sen!2sin" 
        ...
        <div className="order-3 md:order-2 col-span-full md:col-span-1 py-5 md:py-10 px-6">
          <div className="mx-auto max-w-xl space-y-4" >
            ...
            {/* ::Submit Button */}
            <div>
              <button type="submit" className="py-2 px-6 rounded bg-green-400 text-base text-white font-semibold uppercase hover:bg-green-500" onClick={addqueries}>Send Message</button>
            </div>
          </div>
        </div>
        ...
        <div className="order-2 md:order-3 col-span-full md:col-span-1 py-5 md:py-10 px-6">
          <div className="mx-auto max-w-xl flex flex-col space-y-5">
            ...
            {/* ::Text */}
            <p className="text-sm text-gray-500">The Counselling center mental health activities focus on early Identification & intervention, as well as prevention of mental health problems of students. Individual counselling sessions are conducted by the counsellor for the students who seek help on their own or are referred. The referrals usually come from Institute Medical officers, and Academic office .The volunteers and Gymkhana members also share mental health concerns of their peers with the counsellor.</p>
            {/* ::Email contact */}
            ...
            {/* ::Address */}
            <p className="text-sm text-gray-500 leading-6"> West wing, 2nd Floor, Abhinandan Bhawan,

Indian Institute of Technology Indore , <br />Khandwa Road,

Simrol, Indore, Pin code 453 552,

Madhya Pradesh <br />India </p>
            {/* ::Socials */}
